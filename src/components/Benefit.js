...
function Benefit() {
  return (
    <div name='benefit' className="p-5 mt-8 bg-[#FFFEFE] ">
      <h1 className="text-5xl text-center mt-3 text-black font-bold tracking-wide mb-5">BENEFITS</h1>
      <div className="grid lg:grid-cols-4 grid-cols-2 items-center justify-center font-[poppins]">
        
        <div className="grid md:grid-cols-2">
          <div className="flex items-center justify-center">
            <GiCheckMark className="text-black hover:animate-pulse text-center px-2 py-2 mb-3 mt-5 m-5 text-5xl lg:text-5xl rounded-lg bg-[#0ACC5A]"/>
          </div>
        ...
        <div className="grid md:grid-cols-2">
          <div className="flex items-center justify-center">
            <GiCheckMark className="text-black hover:animate-pulse text-center px-2 py-2 mb-3 mt-5 text-5xl lg:text-5xl rounded-lg bg-[#0ACC5A]"/>
          </div>
