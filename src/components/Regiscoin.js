...
function Regiscoin() {
  ...
  return (
    ...
    <div className="grid lg:grid-cols-2 md:grid-cols-2 lg:m-10 m-5 items-center justify-center">
        <div>
            <p className="font-[poppins] dark:text-white text-black tracking-wide leading-8 lg:text-start text-x w-[330px] md:w-[400px] lg:w-[490px] text-center" data-aos="fade-left">
      ...
      <div className="m-20">
         ...
         <div className="w-full shadow bg-[#323F52] mt-3 rounded-lg" >
            <div className="bg-blue-500 rounded-lg text-xs leading-none py-[2px] mb-3 text-center dark:text-white text-black w-52" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Liquidify 50%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-orange-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-72" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Team 10%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-green-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-48" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Airdrops 5%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-red-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-32" data-aos="slide-right"></div>
         </div>

         <p className="dark:text-white text-black text-xl">Rewards 18%</p>
         <div className="w-full shadow bg-[#323F52] mt-5 rounded-lg">
            <div className="bg-blue-500 text-xs rounded-lg leading-none py-[2px] mb-3 text-center dark:text-white text-black w-60" data-aos="slide-right"></div>
         </div>
