        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-5 text-center">
          ...
          <div className="flex">
           ...
           <div className="mb-5 grid-cols-4 grid">
            ...
            <CgFacebook href="https://facebook.com/Regizofficial" className="text-center  mx-0 mt-2 text-xl"/>
            </a>
            <a href="https://twitter.com/Regizofficial" type="button" class="rounded-lg border-2 hover:border-[#66CC7B] border-[#FFFEFE] text-[#FFFEFE] leading-normal uppercase hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-10 h-10 m-2">
              <BsTwitter className="text-center mx-0 mt-2 text-xl"/>
            </a>
            ...
            <AiFillLinkedin className="text-center mx-0 mt-2 text-xl"/>
            </a>
            <a href="https://instagram.com/Regizofficial" type="button" class="rounded-lg border-2 hover:border-[#66CC7B] border-[#FFFEFE] text-[#FFFEFE] leading-normal uppercase hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-10 h-10 m-2">
              <AiFillInstagram className="text-center mx-0 mt-2 text-xl"/>
            </a>
            ...
            <HiMail className="text-center mx-0 mt-2 text-xl"/>
            </a>
            ...
            <SiMicrosoftoutlook className="text-center mx-0 mt-2 text-xl"/>
            </a>
            ...
            <BsWhatsapp className="text-center mx-0 mt-2 text-xl"/>
            </a>
            ...
            <BsTelegram className="text-center mx-0 mt-2 text-xl"/>
            </a>
           </div>
