...
function Features() {
  return (
    <div name='feature' className="p-5 mt-8">
      <h1 className="text-5xl text-center mt-3 text-white font-bold tracking-wide mb-5" data-aos="flip-up">FEATURES</h1>
      <div className="grid lg:grid-cols-4 md:grid-cols-2 place-items-center" data-aos="fade-up">

        <div className="bg-white px-6 py-4 rounded-lg shadow-[20px] h-52 lg:w-[265px] m-10 md:w-[320px] w-[250px] flex items-center justify-center hover:bg-[#66CC7B] lg:hover:w-[280px] hover:text-white transition-color duration-200">
        ...
        <div className="bg-white px-6 py-4 mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[275px] m-10 md:w-[320px] w-[250px] flex items-center justify-center hover:bg-[#66CC7B] lg:hover:w-[280px] hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
        ...
        <div className="bg-white px-6 py-4  mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[265px] m-10 md:w-[320px] w-[250px] flex items-center justify-center hover:bg-[#66CC7B] lg:hover:w-[280px] hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
        ...
        <div className="bg-white px-6 py-4  mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[275px] m-10 md:w-[320px] w-[250px] flex items-center justify-center hover:bg-[#66CC7B] lg:hover:w-[280px] hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
          <GrCertificate className="text-7xl text-center flex items-center justify-center border-2  border-green-700 rounded-full px-3 py-3 hover:bg-[#75D95B] hover:border-none transition-color duration-200 hover:fill-white"/>
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 place-items-center" data-aos="fade-up">
        ...
        <div className="bg-white px-6 py-4 mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[275px] m-10 md:w-[320px] w-[250px] flex items-center justify-center hover:bg-[#66CC7B] hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
        ...
        <div className="bg-white px-6 py-4  mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[275px] m-10 md:w-[320px] w-[250px] lg:hover:w-[280px] flex items-center justify-center hover:bg-[#66CC7B] hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
        ...
        <div className="bg-white px-6 py-4  mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[275px] m-10 md:w-[320px] w-[250px] lg:hover:w-[280px] flex items-center justify-center hover:bg-[#66CC7B]  hover:text-white transition-color duration-200">
        <div className="grid place-items-center">
          <FcDocument className="text-7xl text-center flex items-center justify-center border-2  border-green-700 rounded-full px-3 py-3 hover:bg-[#75D95B] hover:border-none transition-color duration-200 hover:fill-white"/>
