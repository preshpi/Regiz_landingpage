      ...
      <h1 className="lg:text-5xl text-3xl text-center mt-3 pt-5 text-black font-bold tracking-wide mb-5 dark:text-white">FEATURES</h1>
        ...
        <div className="lg:m-10 m-10 mt-5">
          <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-5 mb-[20px] place-items-center" data-aos="fade-up">
            ...
            {/* <div className="px-6 py-4 mb-3 mt-3 rounded-lg shadow-[20px] h-52 lg:w-[280px] m-10 md:w-[320px] w-[250px] flex items-center justify-center lg:hover:w-[420px] dark:bg-[#66CC7B] bg-gray-200 hover:text-white transition-color duration-200">
            <div className="grid place-items-center">
