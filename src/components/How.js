...
function How() {
  return (
    <div name='how' className="bg-[#FFFEF1]">
     <h1 className="text-5xl text-center mt-3 text-black font-bold tracking-wide mb-5 pt-5" data-aos="flip-up">How it works</h1>
     <div className="grid lg:grid-cols-2">
        <div>
        <ul className="text-black m-10 font-[poppins]">
                <h3 className="text-3xl mb-3 font-bold">NFT Marketplace</h3>
                ...
                <div className="px-3 py-3 h-12 rounded-lg bg-[#66CC7B]">
                    ...
                    <li className="mx-4  tracking-wide leading-8">Download the Regiz Dapp from your App/Play Store or Visit regiz.io from your web browser.</li>
                </div>
                <div className="flex mt-3" data-aos="fade-right">
                <div className="px-3 py-3 h-12  rounded-lg bg-[#66CC7B]">
                    <FaStarOfLife className="text-xl"/>
                ...
                <div className="px-3 py-3 h-12  rounded-lg bg-[#66CC7B]">
                    ...
                    <li className="mx-4 mb-3 text-x tracking-wide leading-8">List your art for sale.</li>
                </div>
        </ul> 
        </div>
        ...
        <div className="flex items-center justify-center font-[poppins]">
            ...
            <ul className="text-black m-10">
                <h3 className="text-3xl mb-3 font-bold">DUI</h3>
                <div className="flex">
                <div className="px-3 py-3 h-12  rounded-lg bg-[#66CC7B]">
                    <FaStarOfLife className="text-xl"/>
                </div>
