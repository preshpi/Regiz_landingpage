     ...
     <div className="">
      <div className="m-10 grid lg:grid-cols-2">
        ...
        <ul className="text-black m-10 font-[poppins]">
                <h3 className="text-3xl dark:text-[#fff] text-black mb-5 font-bold">Social market place</h3>
        ...
        <div className="flex items-center justify-center font-[poppins]">
            ...
            <ul className="text-black m-10">
                <h3 className="lg:text-3xl text-2xl dark:text-[#fff] text-black mb-5 font-bold">Documentation Technology</h3>
                <div className="flex">
                <div className="px-3 py-3 h-12  rounded-lg bg-[#66CC7B]">
                    <FaStarOfLife className="text-xl"/>
                </div>
